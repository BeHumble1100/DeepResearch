        ...
        messages: list[Message] = [
            {
                ...
                "content": (
                    ...
                    "but should not independently block a final answer. Most premises in a multi-hop "
                    "question are research clues; keep acceptance constraints to one or two.\n\n"
                    "Keep acceptance constraints answer-neutral: describe the relation that must be "
                    "verified, but never name, guess, or select the requested target value. For example, "
                    "for an equipment-name question, use 'the requested equipment can detect the stated "
                    "phenomenon,' not 'the equipment is <guessed name>'.\n\n"
                    ...
                    "Avoid duplicate constraints, bundled conditions, speculative target values, and facts "
