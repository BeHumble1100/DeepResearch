        ...
        messages: list[Message] = [
            {
                ...
                "content": (
                    ...
                    "A comparison or rank fact about a different entity is not a contradiction of an "
                    "unknown final-answer constraint. Mark contradicted only when the passage explicitly "
                    "negates the same candidate or condition required by that constraint; otherwise "
                    "leave that constraint out of the fact's relations.\n\n"
